...
from .views import restaurant_list, restaurant_menus, restaurant_menu_detail,RestaurantDetailView, ReviewAPIView, DishAPIView
...
urlpatterns = [
    ...
    path('api/restaurants/<int:restaurant_id>/reviews/', ReviewAPIView.as_view(), name='restaurant-reviews'),
